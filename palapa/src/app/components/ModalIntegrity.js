...
const ModalIntegrity = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      {/* Container Modal */}
      <div className="relative bg-white p-5 text-[10px] md:text-[15px] w-[100%] md:w-[50%] max-w-3xl rounded-2xl shadow-lg border border-gray-200 text-left overflow-hidden z-[-2]">
        ...
        <br />
        <p className="text-gray-700 leading-relaxed z-2">
