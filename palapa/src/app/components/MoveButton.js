...
export default function KitoButton() {
  ...
  return (
    <div className="w-full bg-gray-100 py-0 md:py-4 overflow-hidden relative">
      <div
        ref={containerRef}
        className="flex space-x-4 w-max whitespace-nowrap animate-kito"
      ...
      >
        {loopedButtons.map((button, index) => (
          ...
          <button
            ...
            onClick={(e) => showDropdown(button.id, e)}
          >
            {button.text}
          </button>
        </div>
